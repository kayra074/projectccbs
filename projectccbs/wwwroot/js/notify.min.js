(function (e) {
    ...
    var t =
        ...
        m = function (t, i) {
            ...
            var o = "";
            i.classes &&
                e.each(i.classes, function (t, n) {
                    return (
                        (o += "." + r + "-" + i.name + "-" + t + " {\n"),
                        e.each(n, function (t, n) {
                            return (
                                p[t] &&
                                e.each(p[t], function (e, r) {
                                    return (o += "	" + r + t + ": " + n + ";\n");
                                }),
                                (o += "	" + t + ": " + n + ";\n")
                            );
    ...
    (A.prototype.loadHTML = function () {
        ...
        (A.prototype.setElementPosition = function () {
            ...
            t.call(u, _) >= 0
                ? (C(p, "left", k(O, h, y)), r && C(r, "left", k(O, i, m)))
                : t.call(o, _) >= 0 &&
                (C(p, "top", k(O, c, d)), r && C(r, "top", k(O, i, v))),
        ...
        (A.prototype.getPosition = function () {
            ...
            if (
                ...
                (((s = e[0]), t.call(o, s) >= 0) && ((f = e[1]), t.call(u, f) < 0))
            )
        ...
        (A.prototype.updateClasses = function () {
            ...
            return (
                (t = ["base"]),
                e.isArray(this.options.className)
        ...
        (A.prototype.run = function (t, n) {
            ...
            e.isPlainObject(n)
                ...
                : e.type(n) === "string" && (this.options.className = n);
            if (this.container && !t) {
                this.show(!1);
                return;
            }
